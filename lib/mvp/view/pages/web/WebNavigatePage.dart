...
/**
 * Web中转站点页面（跳转到浏览器和本地两种方式）
 */
class WebNavigatePage extends StatefulWidget {
  WebNavigatePage({Key key, this.title}) : super(key: key);
  final String title;
...
class _MyHomePageState extends State<WebNavigatePage> with AutomaticKeepAliveClientMixin {
