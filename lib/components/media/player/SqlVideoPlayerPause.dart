...
/// video.
/// 持有 暂停 / 继续 播放状态的播放器（当前页面可见范围内自动播放，不可见范围内自动暂停播放）
...
class VideoPlayerPause extends StatefulWidget {
  final VideoPlayerController controller;

  VideoPlayerPause(this.controller);
...
class _VideoPlayPauseState extends State<VideoPlayerPause> {
    ...
    if (initialized) {
      ...
      return new Center(
        child: new AspectRatio(
          ...
          child: new VideoPlayerPause(controller),
        ),
      );
    } else {
